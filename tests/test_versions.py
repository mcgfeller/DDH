...
def test_version_or_constraint():
    assert isinstance(versions.make_version_or_constraint('4.0'), versions.Version)
    assert isinstance(versions.make_version_or_constraint('>4.0'), versions.VersionConstraint)
