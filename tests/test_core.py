...
def test_nodes():
    ...
    keydirectory.NodeRegistry[keys.DDHkey(key='/mgf/p/health')] = node_c    
    ...
    assert keydirectory.NodeRegistry.get_node(ddhkey_s,nodes.NodeType.nschema)[0].nschema is schema 
    return
